...
entryField = Entry(root, font=('arial', 20, 'bold'), bg='dodgerblue3', fg='white', bd=10, relief=SUNKEN, width=15)
entryField.grid(row=0, column=0, columnspan=9)
...
micButton = Button(root, image=micImage, bd=0, bg='dodgerblue3', activebackground='dodgerblue3'
                   ,command=audio)
micButton.grid(row=0, column=4)

button_text_list = ["C", "CE", "v", "+",
                    "1", "2", "3", "-", 
                    "4", "5", "6", "*", 
                    "7", "8", "9", chr(247), 
                    "0", ".", "%", "="]
